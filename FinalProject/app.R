...
# Data Visualization | Group 5: East Section
# Safety Initiative for South Bend
# by Amanda Suleski, Michael Jaskelevicus, Gabrielle, and Alejandro Pesantez
...
library(keyring)
# Creates new R password protected: keyring_create("Rcredentials")
#keyring_unlock("Rcrednetials")
#key_set("token_key", keyring = "Rcredentials")
key_set('token_keys')

#Create account with ShinyApp
# authorize account
rsconnect::setAccountInfo(name='gabrielle-taylor-3',
                          token=key_get('token_keys'),#key_get('token_key', keyring ="Rcredentials"),
                          secret='p1R0P6nN+N9gRAt1ClfBMHwXzSYovQYjVUqq6608')
...
# lock the keyring: keyring_lock("Rcredentials")
